...
namespace SpinHttpWorld.wit.imports.wasi.clocks.v0_2_1
{
    public static class MonotonicClockInterop {
        ...
        public  static unsafe global::SpinHttpWorld.wit.imports.wasi.io.v0_2_1.IPoll.Pollable SubscribeInstant(ulong when)
        {
        ...
        public  static unsafe global::SpinHttpWorld.wit.imports.wasi.io.v0_2_1.IPoll.Pollable SubscribeDuration(ulong when)
        {
